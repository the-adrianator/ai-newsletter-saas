...
import { DeleteFeedButton } from "@/components/dashboard/DeleteFeedButton";
...
interface RssFeedManagerClientProps {
  feeds: RssFeed[];
  isPro: boolean;
}

export function RssFeedManagerClient({
  feeds,
  isPro,
}: RssFeedManagerClientProps) {
